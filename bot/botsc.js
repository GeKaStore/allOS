...
bot.on('text', async (ctx) => {
    ...
    ctx.reply('ðŸ”„ Mencoba untuk terhubung ke VPS...');
    ...
    try {
        ...
        ctx.reply('ðŸš€ Semua perintah selesai dijalankan! VPS Anda akan direboot.');
        ssh.dispose();
    } catch (err) {
        ctx.reply(`âŒ Gagal terhubung atau menjalankan perintah.\nError: \`${err.message}\``, { parse_mode: 'Markdown' });
    }
});
