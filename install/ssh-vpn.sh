...
REPO2="https://raw.githubusercontent.com/GeKaStore/allOS/main/"
# initializing var
...
wget -O /etc/haproxy/haproxy.cfg "https://raw.githubusercontent.com/GeKaStore/allOS/main/install/haproxy.cfg"
