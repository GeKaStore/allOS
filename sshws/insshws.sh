...
wget -O /usr/local/bin/ws "https://raw.githubusercontent.com/GeKaStore/allOS/main/sshws/ws"
...
wget -O /usr/local/bin/ws-ovpn "https://raw.githubusercontent.com/GeKaStore/allOS/main/sshws/ws"
